    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      <div className="pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-slate-600 max-w-2xl mx-auto px-6">
          Upload your MRI (NIfTI) image to get started. OCT image may be needed if MRI is borderline.
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg ring-1 ring-slate-200">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Upload MRI</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <label
                htmlFor="file-upload"
                className={`flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-xl cursor-pointer transition-colors ${uploadedFile ? 'border-teal-300 bg-teal-50' : 'border-slate-300 bg-slate-50 hover:bg-slate-100'} ${isAnalyzing ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                {uploadedFile ? (
        ...
        {mriResults && mriResults.mriProb < MRI_THRESHOLD && (
          <div className="my-16 bg-white rounded-2xl p-8 shadow-lg ring-1 ring-slate-200">
            ...
            <p className="text-slate-600 mb-6">
              MRI probability is below threshold. Please upload your OCT (retinal scan) image for final diagnosis.
            </p>
              ...
              >
                {octFile ? (
                  <div className="text-center">
                    ...
                    <p className="text-sm font-medium text-blue-800">{octFile.name}</p>
                  </div>
                ) : (
                  <div className="text-center">
                    <Upload className="h-12 w-12 text-slate-400 mx-auto mb-4" />
                    <p className="text-lg font-medium text-slate-700">Drop your OCT file here</p>
                  </div>
                )}
              </label>
            ...
            {octFile && (
              <div className="mt-10 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900">Uploaded OCT Image</h3>
                </div>
                <div className='p-4'>
                  <img
